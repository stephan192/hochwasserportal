...
# This integration is currently only working for BW, BY, HE, MV, NI, NW, RP, SH, SN, ST and TH pegel because the formerly used API has been locked from public usage! I'll try to repair the other pegel also.
